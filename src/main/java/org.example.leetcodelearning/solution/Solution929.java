 ...
 * 输入：emails = ["main.test.email+alex@leetcode.com","main.test.e.mail+bob.cathy@leetcode.com","testemail+david@lee.tcode.com"]
 * 输出：2
...
public class Solution929 {
    ...
    public static void main(String[] args) {
        String[] emails = new String[]{
            "main.test.email+alex@leetcode.com",
            "main.test.e.mail+bob.cathy@leetcode.com",
